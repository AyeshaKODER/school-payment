...
const AdminDashboard = ({ transactions, onLogout }) => {
  ...
  const stats = {
    ...
    success: filteredTransactions.filter((t) => t.status === "success")
      .length,
    ...
    totalAmount: filteredTransactions.reduce(
      (sum, t) => sum + (t.transaction_amount || 0),
      0
    ),
  };
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          ...
          <div className="px-6 py-4 bg-green-50 border-t border-gray-200 rounded-b-lg">
            <div className="flex items-center justify-between text-sm text-green-800">
              <div>
                ✅ Data loading successfully • Showing{" "}
...
function App() {
  ...
  // Admin routes
  if (userType === "admin") {
    return <AdminDashboard transactions={transactions} onLogout={logout} />;
  }
...
const SCHOOLS = [
  {
    ...
    name: "Bhavana Newsprint Vidyalaya Vellore",
  },
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder={
                isLogin
                  ? "admin@school.com for admin access"
                  : "Enter your email"
              }
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
              placeholder={
                isLogin ? "admin123 for admin access" : "Create a password"
              }
            />
          </div>
...
const MakePaymentPage = ({ user, onPaymentSubmit, onNavigate }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const newTransaction = {
      ...
      institute_name:
        SCHOOLS.find((s) => s.id === paymentData.schoolId)?.name ||
        "Unknown School",
      student_info: {
              ...
              <div className="bg-blue-50 rounded-lg p-4 border border-blue-200">
                ...
                <div className="space-y-1 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      ₹
                      {(parseFloat(paymentData.amount || 0) * 0.01).toFixed(
                        2
                      )}
                    </span>
                  </div>
                  <div className="flex justify-between font-bold text-blue-900 pt-2 border-t border-blue-200">
                    ...
                    <span>
                      ₹
                      {(parseFloat(paymentData.amount || 0) * 1.01).toFixed(
                        2
                      )}
                    </span>
                  </div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {
                    userTransactions.filter((t) => t.status === "success")
                      .length
                  }
                </p>
              </div>
